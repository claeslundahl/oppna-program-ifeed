 ...
 *         &lt;element name="namespaceId" type="{http://www.w3.org/2001/XMLSchema}string" form="qualified"/>
 *         &lt;element name="internalId" type="{http://www.w3.org/2001/XMLSchema}string" form="qualified"/>
 *         &lt;element name="sourceId" type="{http://www.w3.org/2001/XMLSchema}string" form="qualified"/>
 *         &lt;element name="synonyms" type="{urn:Node.schema.metaservice.vgr.se:v2}SynonymsListType" minOccurs="0" form="qualified"/>
 *         &lt;element name="nodeProperties" type="{urn:Node.schema.metaservice.vgr.se:v2}NodePropertyListType" minOccurs="0" form="qualified"/>
 *         &lt;element name="parents" type="{urn:Node.schema.metaservice.vgr.se:v2}NodeListType" minOccurs="0" form="qualified"/>
 *         &lt;element name="userStatus" type="{urn:Node.schema.metaservice.vgr.se:v2}UserStatusListType" minOccurs="0" form="qualified"/>
 *         &lt;element name="hasChildren" type="{http://www.w3.org/2001/XMLSchema}boolean" form="qualified"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
