...
public class LdapPersonServiceImp implements LdapPersonService, InitializingBean {
    ...
    private AttributesMapper getAttributesMapper() {
        final AttributesMapper attributesMapper = new AttributesMapper() {
            ...
            public Object mapFromAttributes(final Attributes attributes) throws NamingException {
                final String organisation = attributes.get(_organisationAttribute) != null ? attributes.get(_organisationAttribute).get().toString() : null;
                final String firstName = attributes.get(_firstnameAttribute) != null ? attributes.get(_firstnameAttribute).get().toString() : null;
                final String lastName = attributes.get(_lastnameAttribute) != null ? attributes.get(_lastnameAttribute).get().toString() : null;
                final String userName = attributes.get(_usernameAttribute) != null ? attributes.get(_usernameAttribute).get().toString() : null;
                final String email = attributes.get(_emailAttribute) != null ? attributes.get(_emailAttribute).get().toString() : null;
