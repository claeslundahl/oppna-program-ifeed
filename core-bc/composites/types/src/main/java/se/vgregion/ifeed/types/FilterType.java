...
public enum FilterType {
    ...
    CREATED_FOR(
            EnumSet.<Filter> of(H_O_S, CREATED_FOR_UNIT, PUBLISHED_FOR_UNIT, CREATED_FOR_PROJECT, PUBLISHED_FOR_PROJECT)
    ),
    CONTEXT(
    ...
    STATUS_AND_LIMITATIONS(
            EnumSet.<Filter> of(VALID_FROM_DATE, VALID_TO_DATE, AVAILABLE_FROM_DATE, AVAILABLE_TO_DATE, PUBLISHING_DATE, PUBLIC_ACCESSIBILITY)
    ),
    CREATED_BY(
    ...
    public enum Filter {
        H_O_S(""), CREATED_FOR_UNIT(""), PUBLISHED_FOR_UNIT(""), CREATED_FOR_PROJECT(""), PUBLISHED_FOR_PROJECT(""),
        ...
        VALID_FROM_DATE(""), VALID_TO_DATE(""), AVAILABLE_FROM_DATE(""), AVAILABLE_TO_DATE(""), PUBLISHING_DATE(""),
