...
public class BeanMap implements Map<String, Object> {
    ...
    public Object put(String key, Object value) {
        ...
        try {
            ...
            e.printStackTrace();
            String text = ("Key " + key + " failed. Type is " + pd.getPropertyType().getName() + " value is " + value.getClass().getName() + " actual value is " + value);
    ...
    private <Ot> Ot convert(Object value, Class<Ot> type) throws IllegalAccessException {
        ...
        return (Ot) converters.get(type).apply(value);
    }
    ...
    public Method getMethod(String withName) {
...

    {
        ...
        converters.put(Boolean.class, s -> new Boolean(Boolean.parseBoolean(s + "")));
    ...
    public Class<?> getType(String name) {
        return getPropertyDesc(name).getPropertyType();
    }
