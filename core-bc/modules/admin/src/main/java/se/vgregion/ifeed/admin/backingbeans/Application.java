...
import se.vgregion.ifeed.admin.el.AccessGuard;
import se.vgregion.ifeed.admin.formbean.VgrOrganization;
import se.vgregion.ifeed.admin.identity.PortalException;
import se.vgregion.ifeed.admin.identity.PortalUtil;
import se.vgregion.ifeed.admin.identity.SystemException;
import se.vgregion.ifeed.service.LdapLoginService;
...
public class Application {
    ...
    public Application() {
        super();
        System.out.println("Default Application constructor.");
    }

    public Application(IFeedService iFeedService) {
        super();
        this.iFeedService = iFeedService;
        System.out.println("One-argument Application constructor.");
    }
    ...
    public String dumpSessionValues() {
        System.out.println("dumpSessionValues");
    ...
    public void login(String userId, String password) {
        try {
            user = ldapLoginService.login(userId, password);
    ...
    public void handleSingleSignOn() {
        if (user != null) {
        ...
        String requestHeaderName = "iv-user";
        ...
        try {
            user = ldapLoginService.loginWithoutPassword(userName);
    ...
    User getUser(ServletRequest request) throws PortalException, SystemException {
    ...
    public boolean mayEditFeed(ServletRequest request, IFeed feed) throws SystemException, PortalException {
        if (iFeedModelBean.getInitalFeed() != null && iFeedModelBean.getInitalFeed().getId().equals(feed.getId())) {
            ...
            return AccessGuard.mayEditFeed(getUser(), iFeedModelBean.getInitalFeed());
        }
        return AccessGuard.mayEditFeed(getUser(), feed);
    }
...
*/
    ...
    public void copyAndPersistFeed(ServletRequest request, Long withThatKey)
        throws SystemException, PortalException {
        User user = getUser(request);
        viewIFeed(iFeedService.copyAndPersistFeed(withThatKey, user.getId()).getId());
        setInEditMode(true);
    }
