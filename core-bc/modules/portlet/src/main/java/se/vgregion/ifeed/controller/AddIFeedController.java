...
public class AddIFeedController {
    ...
    public void addIFeed(final Model model, @Valid @ModelAttribute(value = "ifeed") IFeed iFeedIn,
                         final BindingResult bindingResult, final ActionRequest request, final ActionResponse response, PortletRequest portletRequest) {
        if (!bindingResult.hasErrors()) {
            ...
            try {
                ...
                long userId = getUserId(portletRequest);
    ...
    long getCompanyId(PortletRequest portletRequest) {
        return PortalUtil.getCompanyId(portletRequest);
    }
