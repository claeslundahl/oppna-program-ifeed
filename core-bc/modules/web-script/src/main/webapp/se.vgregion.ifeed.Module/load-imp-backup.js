...
try {
    function se_vgregion_ifeed_Module() {
        ...
        function sendStats(evtGroupString, typeString) {
            if ($wnd_0.__gwtStatsEvent) {
                $wnd_0.__gwtStatsEvent({
                    moduleName: 'se.vgregion.ifeed.Module',
        ...
        function getCompiledCodeFilename() {
            ...
            var strongName;
            try {
                unflattenKeylistIntoAnswers(['ie9'], 'implementation');
                unflattenKeylistIntoAnswers(['ie8'], 'implementation');
                unflattenKeylistIntoAnswers(['safari'], 'implementation');
                unflattenKeylistIntoAnswers(['ie10'], 'implementation');
                unflattenKeylistIntoAnswers(['gecko1_8'], 'implementation');
