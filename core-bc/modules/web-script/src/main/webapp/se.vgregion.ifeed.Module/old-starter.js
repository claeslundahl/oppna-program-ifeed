function se_vgregion_ifeed_Module(){
    ...
    function getCompiledCodeFilename(){
        ...
        var strongName;
        try {
            unflattenKeylistIntoAnswers(['ie9'], '2CCE03835371234C98A3AC86150903E8');
            unflattenKeylistIntoAnswers(['ie8'], '59F2E72EE9F3B38935CD478CFD79EBBF');
            unflattenKeylistIntoAnswers(['safari'], '71EB33095E6ABD0CEAD5BB753FA769DA');
            unflattenKeylistIntoAnswers(['ie10'], 'A75F63C1EDB1CE20FDA85D5E55646B31');
            unflattenKeylistIntoAnswers(['gecko1_8'], 'C99B0B235BBD69B0660657B9012DA16D');
