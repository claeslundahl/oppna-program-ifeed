...
<table onmouseoutx="for (var i = 0; i < document.getElementById('se.vgregion.ifeed.Module').contentWindow.previousTooltip.length; i++) document.getElementById('se.vgregion.ifeed.Module').contentWindow.onTooltipOut(previousTooltip[i]);"
                ...
                <td class="ifeed-head-td">
                    <div>
                        <a class="gwt-Anchor" href="#"
                           onclick="javascript:document.getElementById('se.vgregion.ifeed.Module').contentWindow.toggleFeedOrder(this, '${column.key}'); this.onclick = ''; return false;"
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td align="left" style="vertical-align: top;">
                            <a onclick="document.getElementById('se.vgregion.ifeed.Module').contentWindow.openMetadataDetails('${item.id}')" class="root-tool"
                               style="text-decoration: none;"
                               onmouseout="document.getElementById('se.vgregion.ifeed.Module').contentWindow.onTooltipOut(this.children[1]); return false;"
                               onmouseover="document.getElementById('se.vgregion.ifeed.Module').contentWindow.fillDocumentDetailTooltip('${item.id}', this.children[1])">
