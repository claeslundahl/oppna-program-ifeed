    ...
    <div class="document-metadata" id="table-container">
        ...
        <table class="ifeed-metadata-table" style="text-decoration: none;">
            ...
            <tbody>
                ...
                <tr><td class="key" style="text-decoration: none;">Myndighet</td><td class="value" style="text-decoration: none;">${item['core:ArchivalObject.core:Producer.idType']}</td></tr>
                ...
                <tr><td class="key" style="text-decoration: none;">Innehållsansvarig</td><td class="value" style="text-decoration: none;">${item['vgrsd:DomainExtension.vgrsd:ContentResponsible.compRole']}</td></tr>
                <tr><td class="key" style="text-decoration: none;">Godkänt av</td><td class="value" style="text-decoration: none;">${item['vgrsd:DomainExtension.vgrsd:DocumentApproved.id']}</td></tr>
