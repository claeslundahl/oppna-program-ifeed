...
public enum FilterType {
    ...
    public enum Filter {
        ...
        PUBLISHED_BY("dc.publisher", TEXT_FREE, ""),
        RESPONSIBLE("dc.creator.document", TEXT_FREE, ""),
        ...
        SAVED_BY("dc.contributor.savedby", TEXT_FREE, ""),
        CREATED_BY_FIX("dc.creator", TEXT_FREE, ""),
