...
public enum FilterType {
    ...
    MANAGED_BY(
            EnumSet.<Filter> of(PUBHLISHED_BY, RESPONSIBLE, RESPONSIBLE_FUNC)
    ),
    ...
    public enum Filter {
        ...
        DOCUMENT_SERIES(""), DOCUMENT_SERIES_ID(""), PHYSICAL_LOCATION(""), PUBHLISHED_BY(""), RESPONSIBLE(""), RESPONSIBLE_FUNC(""),
